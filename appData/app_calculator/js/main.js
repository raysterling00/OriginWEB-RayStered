...
function calculate_calc() {
	...
	else if (display_calc.innerText === "Isn't defined") return

	if (display_calc.innerText === "1:0") {
		display_calc.innerText = "Isn't defined"
	} else {
		try {
			const expression = display_calc.innerText.replace(/:/g, "/").replace(/×/g, "*")
