function showPopupInput(options) {
	const { message = "", placeholder = "", defaultText = "", maxLength = null, buttonText = "OK", cancelText = "Cancel", onSubmit, onCancel } = options
...
function showPopup2_alert(message_alert, yesText_alert = "Yes", noText_alert = "No", onYes_alert = null, onNo_alert = null) {
